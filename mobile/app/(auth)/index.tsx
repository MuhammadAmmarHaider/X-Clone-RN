    ...
    <View className="flex-1 bg-white">
      ...
      <View className="flex-1 justify-center">
          ...
          <View className="flex-col gap-2">
            ...
            >
              {isLoading?(
                ...
                <Image source={require('../../assets/images/google.png')} className="size-10 mr-3" resizeMode="cover"/>
            ...
            >
              {isLoading ?(
                ...
                <View className="flex-row items-center justify-center">
                <Image source={require('../../assets/images/apple.png')} className="size-10 mr-3" resizeMode="contain"/>
          ...
          <Text className="text-center text-gray-500 text-xs leading-4 mt-6 px-2">
            ...
            {", and "}<Text className="text-blue-500">Cookie User</Text>.
          </Text>
      </View>
      </View>
    </View>
